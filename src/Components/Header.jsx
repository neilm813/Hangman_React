...
class Header extends Component {
	...
	render() {
		...
		if (this.props.isRoundWon()) letterClasses += ' text-success';
		else if (this.props.isRoundLost()) letterClasses += ' text-danger';
					...
					<div id="challenge-word-letters-wrap">
						{
							nElems(this.props.word.length, i => (
								<span
									key={i}
									className={letterClasses}>{this.props.letterIdxsToReveal.includes(i) || this.props.isRoundLost() ? this.props.word[i] : '\u00A0' /* &nbsp; */}
								</span>
							))
						}
					</div>
